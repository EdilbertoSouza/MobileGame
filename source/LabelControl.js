...
var LabelTestScene = cc.Scene.extend({
...
var LabelControl = AtlasDemo.extend({
    time:null,
    ctor:function () {
        this.time = 0;

        var lblVelocidade = cc.LabelAtlas.create("123 km/h", "res/fonts/tuffy_bold_italic-charmap.plist");
        this.addChild(lblVelocidade, 0, TAG_LABEL_SPRITE1);
        lblVelocidade.setPosition(cc.p(10, 100));
        lblVelocidade.setOpacity(200);

        var lblTempo = cc.LabelAtlas.create("0123456789", "res/fonts/tuffy_bold_italic-charmap.plist");
        this.addChild(lblTempo, 0, TAG_LABEL_SPRITE12);
        lblTempo.setPosition(cc.p(10, 200));
        lblTempo.setOpacity(32);
    ...
    step:function (dt) {
        ...
        var lblVelocidade = this.getChildByTag(TAG_LABEL_SPRITE1);
        var string1 = this.time.toFixed(2) + " km/h";
        lblVelocidade.setString(string1);

        var lblTempo = this.getChildByTag(TAG_LABEL_SPRITE12);
        var string2 = parseInt(this.time).toString();
        lblTempo.setString(string2);
    },
    title:function () {
        return "LabelAtlas";
    },
